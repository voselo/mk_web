...
<?php esc_html_e( 'Skip to content', 'skt-roofing-lite' ); ?>
</a>
<?php
...
<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}else{if(!is_home() && $header_trans_inner == '') {echo esc_html('transheader');}}?>">
    <div class="logo">
		<?php skt_roofing_lite_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
            ...
            <div class="header-right-infos">
                <div class="header-phone-number">
                    <?php if (!empty($header_phonenumbertext)) { ?>
                        <img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/header-phone-icon.png">
                        <span><?php esc_html_e('Have any Question?','skt-roofing-lite');?></span>
