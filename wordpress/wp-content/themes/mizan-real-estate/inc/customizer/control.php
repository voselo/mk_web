 ...
 */
class Mizan_Real_Estate_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'mizan-real-estate' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'mizan-real-estate-customize-controls' );
		wp_enqueue_script( 'mizan-real-estate-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Mizan_Real_Estate_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
