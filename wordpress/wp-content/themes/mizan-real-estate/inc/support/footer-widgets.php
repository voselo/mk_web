 ...
 * @since 1.0.0
 */
class Mizan_Real_Estate_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'mizan_real_estate';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'mizan-real-estate' ), $i ),
...
// Initialize.
$Mizan_Real_Estate_Footer_Widgets = new Mizan_Real_Estate_Footer_Widgets();