jQuery(document).ready(function($) {
    'use strict';
    var this_obj = mizan_real_estate_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.mizan-real-estate-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message mizan-real-estate-plugin-install');
                button.addClass('button-primary mizan-real-estate-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.mizan-real-estate-recommended-plugins .mizan-real-estate-activation-note').css('display','block');
    ...
    $(document).on('click', '.mizan-real-estate-plugin-activate', function(event) {
