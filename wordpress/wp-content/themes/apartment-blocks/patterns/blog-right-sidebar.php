 ...
 * Slug: apartment-blocks/blog-right-sidebar
 * Categories: apartment-blocks, blog-right-sidebar
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','apartment-blocks'); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"apartment-blocks","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->