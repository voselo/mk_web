...
/**
 * Title: Header Image
 * Slug: apartment-blocks/header-image
 * Categories: apartment-blocks, header-image
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.png'); ?>","id":15,"dimRatio":0,"minHeight":300} -->
